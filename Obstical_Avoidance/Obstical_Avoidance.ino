...
const int sonarTrig = 11;   // Connect the sonar Trig pin (Blue wire) to pin #11 on the Pro Trinket.
const int sonarEcho = 12;   // Connect the sonar Echo pin (Yellow wire) to pin #12 on the Pro Trinket.
